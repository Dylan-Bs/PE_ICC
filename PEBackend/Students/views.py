                    ...
                    if user.is_staff:
                        ...
                        for student in students:
                            ...
                            if tmp_user != None and tmp_user.is_active:
                                data.append({"id": str(tmp_user.id), "name": str(tmp_user.first_name)+" "+str(tmp_user.last_name), "email": str(tmp_user.username), "promotion": str(student.promotion), "option": str(student.option),"company": str(student.company), "wage" : str(student.wage), "working_city": str(student.working_city), "linkedin_url": str(student.linkedin_url)})
                            else:
